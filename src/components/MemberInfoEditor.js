    ...
    <main className="col-sm-10 my-2">
        <form>
            ...
            <div className="form-group row">
                ...
                <input type="text" className="form-control-plaintext col-sm-9" id="account" name="account" defaultValue="gogolaichoowan" />
            </div>
            {/* 電子信箱 */}
            <div className="form-group row">
                ...
                <input type="email" id="email" name="email" className="form-control col-sm-9 mx-3" />
            </div>
            {/* 密碼 */}
            <div className="form-group row">
                ...
                <input type="password" id="password" name="password" className="form-control col-sm-9 mx-3" />
            </div>
            {/* 確認密碼 */}
            <div className="form-group row">
            ...
            <div className="form-group row">
                ...
                <input type="text" id="name" name="name" className="form-control col-sm-9 mx-3" />
            ...
            <div className="form-group row">
                ...
                <input type="text" id="nickname" name="nickname" className="form-control col-sm-9 mx-3" />
            </div>
            {/* 性別 */}
            <div className="form-group row">
                <label htmlFor="gender" className="col-sm-2 col-form-label px-0 text-right rwd-text">性別</label>
                <select id="gender" name="gender" className="form-control col-sm-3 mx-3">
            ...
            <div className="form-group row">
                ...
                <input type="date" id="birthday" name="birthday" className="form-control col-sm-3 mx-3" />
            </div>
            {/* 手機 */}
            <div className="form-group row">
                ...
                <input type="tel" id="mobile" name="mobile" className="form-control col-sm-7 mx-3" pattern="[0-9]{4}-[0-9]{3}-[0-9]{3}" />
            ...
            <div className="form-group row">
                <label htmlFor="address" className="col-sm-2 col-form-label px-0 text-right rwd-text">地址</label>
                    ...
                    <input type="text" id="address" name="address[]" className="form-control col-sm-5" placeholder="" />
            </div>
            {/* 自我介紹 */}
            <div className="form-group row">
