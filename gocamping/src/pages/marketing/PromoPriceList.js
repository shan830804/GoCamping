...
class PromoPriceList extends Component {
  ...
  async componentDidMount() {
    try {
      ...
      const response = await fetch('http://localhost:5000/getPromoPriceCamp/'+this.state.currentPage, {
        method: 'GET',
        headers: new Headers({
  ...
  changeCurrentPage = async (currentPage) => {
    try {
      ...
      let url = 'http://localhost:5000/getPromoPriceCamp/'+currentPage
          ...
          <div className="row" id="promo_item_list">
            ...
            <div className="col-md-9">
              ...
              <div className="mb-4 discription_block">
                ...
                <div>
                <div className="promo_discription_img" style={{backgroundImage: "url(" + '/marketingimg/promo_price.jpg' + ")"}}><h4>滿額折扣</h4></div>
