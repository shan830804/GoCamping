...
import MemberEventList from '../../components/MemberEventList';
...
import PostList from '../../components/MemberPostList';
import Level from '../../components/MemberLevel';
// import CampDetails from '../campSide/CampDetails'
            ...
            <Router>
                <div className="container">
                    <section className="my-2">
                        ...
                        <div className="row">
                            <Aside />
                            <Route exact path="/Member" component={CampingOrder} />
                            ...
                            <Route exact path="/Member/MyEventOrder/EventList/:apply_id" component={MemberEventList} />
