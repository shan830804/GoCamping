...
class SharaNew extends React.Component {
  constructor(props) {
    super(props)
                ...
                <Link to={'/ShareFun/post/' + content.post_id}>
                  <figure className="new_post">
                    ...
                    <figcaption>
                      ...
                      <LinesEllipsis className="fs-20 fw-medium sm-title" text={content.post_title}  maxLine='2' ellipsis='...' trimRight basedOn='letters'/>                    <p>{content.post_content.replace(regex, '').slice(0,60)}</p>
