...
class NewIdx extends React.Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    let self = this
    fetch('http://localhost:5000/new-idx')
                  ...
                  <figure className="new_post">
                    ...
                    <figcaption>
                      ...
                      <LinesEllipsis className="fs-20 fw-medium sm-title" text={content.post_title}  maxLine='2' ellipsis='...' trimRight basedOn='letters'/>                     
                        <LinesEllipsis text={content.post_content.replace(regex, '')}  maxLine='3' ellipsis='...' trimRight basedOn='letters'/>
                      </div>
                    </figcaption>
                  </figure>
                </Link>
