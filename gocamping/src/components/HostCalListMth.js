...
class HostCalListMth extends React.Component {
    render() {
        return (
            <main className="col-sm-12 my-2">
                ...
                <aside className="my-2">
                    ...
                    <li className="breadcrumb-item"><Link to="/host"><i class="fas fa-home"></i></Link></li>
                        <li className="breadcrumb-item">日曆管理</li>
                    </ol>
                </aside>
                {/* 區域選擇 */}
                <div className="d-flex flex-column">
                    ...
                    <table>
                        <tbody>
                            <tr className="border">
                                <td className="text-center py-2 pl-2" colSpan="2">點選日期，查看日期的詳細資訊</td>
                            </tr>
                        </tbody>
                    </table>
                    <br/>
                    <table>
                        <tbody>
                            <tr className="">
                                <td className="text-left py-2 pl-2 fs-18 watermelon">當月出租帳數合計：</td>
                            </tr>
                        </tbody>
                    </table> */}
                </div>
