...
class CampOrder01 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      total: props.order.camplist_price * +props.saleorder_number,
 ...
 componentWillReceiveProps(nextProps) {
  ...
  render() {
    ...
    // console.log(this.props.order.camplist_name)
    // console.log(this.state.camplistData)
    return (
      <>
        {/* 進入訂單第一步 訂單明細*/}
              ...
              <Table bordered>
                ...
                <tbody>
                  <tr className="text-center justify-content-center">
                    ...
                    <td>{this.props.order.camplist_name}</td>
                    <td>
                    <p><NumberFormat value={this.props.order.camplist_price} displayType={'text'} thousandSeparator={true} prefix={'NT$'} /></p>
                    </td>
                    <td>
                      <div className="">
