...
const HostCalDetail = props => (
    <main className="col-sm-12 my-2">
        ...
        <aside className="my-2">
            ...
            <li className="breadcrumb-item"><Link to="/host">首頁</Link></li>
                ...
                <li className="breadcrumb-item">查看更多</li>
            </ol>
        </aside>
        {/* 標題一 */}
            ...
            <table className="host-table">
                <tbody>
                    ...
                    <tr className="border">
                        ...
                        <td className="text-left py-2 pl-2">2019-05-22</td>
                    </tr>
                    <tr className="border">
                    ...
                    <tr className="border">
                        <td className="text-center py-2 bg-grass text-white">訂購人姓名</td>
                        <td className="text-left py-2 pl-2" colSpan="3">林宛臻</td>
                    </tr>
                    <tr className="border">
                        <td className="text-center py-2 bg-grass text-white">訂購人電話</td>
                        <td className="text-left py-2 pl-2" colSpan="3">0935-583-219</td>
                    </tr>
                    <tr className="border">
                        <td className="text-center py-2 bg-grass text-white">訂購人信箱</td>
                        <td className="text-left py-2 pl-2" colSpan="3">linwanchen0604@gmail.com</td>
                    </tr>
                    <tr className="border">
                        <td className="text-center py-2 bg-grass text-white">代表人姓名</td>
                        <td className="text-left py-2 pl-2" colSpan="3">林小杵</td>
                    </tr>
                    <tr className="border">
                        <td className="text-center py-2 bg-grass text-white">代表人電話</td>
                        <td className="text-left py-2 pl-2" colSpan="3">0985-981-974</td>
                    </tr>
                    <tr className="border">
                        <td className="text-center py-2 bg-grass text-white">代表人信箱</td>
